...
typedef XrResult(XRAPI_PTR* PFN_xrCreateXDevListMNDX)(XrSession session, const XrCreateXDevListInfoMNDX* info,
                                                      XrXDevListMNDX* xdevList);
typedef XrResult(XRAPI_PTR* PFN_xrGetXDevListGenerationNumberMNDX)(XrXDevListMNDX xdevList, uint64_t* outGeneration);
typedef XrResult(XRAPI_PTR* PFN_xrEnumerateXDevsMNDX)(XrXDevListMNDX xdevList, uint32_t xdevCapacityInput,
                                                      uint32_t* xdevCountOutput, XrXDevIdMNDX* xdevs);
typedef XrResult(XRAPI_PTR* PFN_xrGetXDevPropertiesMNDX)(XrXDevListMNDX xdevList, const XrGetXDevInfoMNDX* info,
