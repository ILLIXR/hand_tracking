...
namespace tflite_operations {
    namespace {
        ...
        inline void TransposeConvBias(const ::tflite::ConvParams& params, const ::tflite::RuntimeShape& input_shape,
                                      ...
                                      const float* bias_data, const ::tflite::RuntimeShape& output_shape, float* output_data,
        ...
        TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
            ...
            case kTfLiteFloat32: {
                ...
                TransposeConvBias(op_params, ::tflite::GetTensorShape(input), ::tflite::GetTensorData<float>(input),
                                  ::tflite::GetTensorShape(weights), ::tflite::GetTensorData<float>(weights),
