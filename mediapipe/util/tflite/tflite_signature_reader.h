...
public:
    ...
    GetInputOutputTensorNamesFromTfliteSignature(const tflite::Interpreter& interpreter,
    ...
    // model.
    static absl::StatusOr<absl::flat_hash_map<SignatureName, SignatureInputOutputTensorNames>>
    GetInputOutputTensorNamesFromAllTfliteSignatures(const tflite::Interpreter& interpreter);
};
