...
public:
    static absl::Status GetContract(CalculatorContract* cc) {
        ...
        RET_CHECK_GE(cc->Options<::mediapipe::CollectionHasMinSizeCalculatorOptions>().min_size(), 0);
    ...
    absl::Status Open(CalculatorContext* cc) override {
        ...
        min_size_ = cc->Options<::mediapipe::CollectionHasMinSizeCalculatorOptions>().min_size();
