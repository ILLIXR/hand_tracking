...
public:
    ...
    absl::Status Init(const mediapipe::InferenceCalculatorOptions::InputOutputConfig& io_config,
                      const InputOutputTensorNames& input_output_tensor_names_map, tflite::Interpreter* interpreter);
...
private:
    ...
    ConvertSignatureTensorNamesToModelIndices(const mediapipe::InferenceCalculatorOptions::InputOutputConfig& io_config,
