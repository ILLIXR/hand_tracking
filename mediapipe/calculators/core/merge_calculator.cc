...
namespace api2 {
    ...
    public:
        ...
        static absl::Status UpdateContract(CalculatorContract* cc) {
            ...
            if (kIn(cc).Count() == 1) {
                ABSL_LOG(WARNING) << "MergeCalculator expects multiple input streams to merge but is "
        ...
        absl::Status Process(CalculatorContext* cc) final {
            ...
            ABSL_LOG(WARNING) << "Empty input packets at timestamp " << cc->InputTimestamp().Value();
