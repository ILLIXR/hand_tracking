...
public:
    ...
    public:
        ...
        // Internal use.
        GraphServiceRequest(const GraphServiceBase& service)
            : service_(service) { }
    ...
    using ServiceReqMap = absl::flat_hash_map<absl::string_view, GraphServiceRequest>;
