...
namespace internal {
    ...
    public:
        ...
        absl::Status Initialize(const std::string& stream_name, const PacketType* packet_type,
                                OutputStreamManager* output_stream_manager, bool observe_timestamp_bounds = false);
    ...
    protected:
        ...
        public:
            GraphOutputStreamHandler(std::shared_ptr<tool::TagMap> tag_map, CalculatorContextManager* cc_manager,
