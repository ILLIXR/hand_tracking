...
public:
    ...
    virtual absl::Status Initialize(const ValidatedGraphConfig* validated_graph, mediapipe::Executor* executor,
    ...
    virtual absl::Status RunGraphSetup(const std::map<std::string, Packet>& input_side_packets,
...
private:
    ...
    absl::Status ExecuteGenerators(std::map<std::string, Packet>* output_side_packets,
