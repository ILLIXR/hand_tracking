...
namespace api2 {
    namespace internal {
        ...
        using tuple_index_sequence = std::make_index_sequence<std::tuple_size_v<std::decay_t<Tuple>>>;

        // Concatenates multiple std::index_sequences.
        template<std::size_t... I>
        constexpr auto index_sequence_cat(std::index_sequence<I...>) -> std::index_sequence<I...> {
            return {};
        }
        ...
        constexpr auto filtered_tuple_indices_impl(Tuple&& t, std::index_sequence<I...>) {
            UNUSED(t);
            return index_sequence_cat(std::conditional_t<Pred<std::tuple_element_t<I, std::decay_t<Tuple>>>::value,
        ...
        constexpr auto filtered_tuple_indices(Tuple&& tuple) {
            return filtered_tuple_indices_impl<Pred>(tuple, tuple_index_sequence<Tuple>());
        }
        ...
        constexpr auto filtered_tuple_indices_impl(Tuple&& t, std::index_sequence<I...>) {
            UNUSED(t);
            return index_sequence_cat(std::conditional_t<F{}(Wrap<std::tuple_element_t<I, std::decay_t<Tuple>>>{}),
                                                         std::index_sequence<I>, std::index_sequence<>>{}...);
        }
        ...
        constexpr auto filtered_tuple_indices(Tuple&& tuple) {
            return filtered_tuple_indices_impl<F>(std::forward<Tuple>(tuple), tuple_index_sequence<Tuple>());
        }
        ...
        constexpr auto filter_tuple(Tuple&& t) {
            return select_tuple_indices(std::forward<Tuple>(t), filtered_tuple_indices<Pred>(t));
        }
        ...
        constexpr auto filter_tuple(Tuple&& t) {
            return select_tuple_indices(std::forward<Tuple>(t), filtered_tuple_indices<F>(std::forward<Tuple>(t)));
        }

        // TODO: ensure only one of these is enabled?
        template<class F, class T, class I>
        constexpr auto call_with_optional_index(F&& f, T&& t, I i) -> absl::void_t<decltype(f(std::forward<T>(t), i))> {
            return f(std::forward<T>(t), i);
        }

        template<class F, class T, class I>
        constexpr auto call_with_optional_index(F&& f, T&& t, I i) -> absl::void_t<decltype(f(std::forward<T>(t)))> {
            UNUSED(i);
        ...
        constexpr void tuple_for_each_impl(F&& f, Tuple&& tuple, std::index_sequence<I...>) {
            int unpack[] = {(call_with_optional_index(std::forward<F>(f), std::get<I>(std::forward<Tuple>(tuple)),
        ...
        constexpr void tuple_for_each(F&& f, Tuple&& tuple) {
            return tuple_for_each_impl(std::forward<F>(f), std::forward<Tuple>(tuple), tuple_index_sequence<Tuple>());
        }
        ...
        constexpr auto map_tuple(F&& f, Tuple&& tuple) {
            return map_tuple_impl(std::forward<F>(f), std::forward<Tuple>(tuple), tuple_index_sequence<Tuple>());
        }
        ...
        constexpr auto tuple_apply(F&& f, Tuple&& tuple) {
            return tuple_apply_impl(std::forward<F>(f), std::forward<Tuple>(tuple), tuple_index_sequence<Tuple>());
        }
        ...
        constexpr std::enable_if_t<i != std::tuple_size_v<std::decay_t<Tuple>>, std::size_t> tuple_find(F&& f, Tuple&& tuple) {
            ...
            return tuple_find<F, Tuple, i + 1>(std::forward<F>(f), std::forward<Tuple>(tuple));
        }
