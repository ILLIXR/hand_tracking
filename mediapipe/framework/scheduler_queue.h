...
namespace internal {
    ...
    public:
        ...
        // not lost.
        void AddNode(CalculatorNode* node, CalculatorContext* cc) ABSL_LOCKS_EXCLUDED(mutex_);
    ...
    private:
        ...
        // by EndScheduling.
        void RunCalculatorNode(CalculatorNode* node, CalculatorContext* cc) ABSL_LOCKS_EXCLUDED(mutex_);
