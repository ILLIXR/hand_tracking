...
public:
    ...
    inline TraceEvent& set_event_data(int64_t data) {
        UNUSED(data);
        return *this;
    }
};
...
public:
    ...
    inline absl::Status GetCalculatorProfiles(std::vector<CalculatorProfile>*) const {
    ...
    inline absl::Status Stop() {
        return absl::OkStatus();
    }

    inline GraphTracer* tracer() {
        return nullptr;
    }
