...
using ExecutorRegistry = GlobalFactoryRegistry<absl::StatusOr<Executor*>, const MediaPipeOptions&>;

// Macro for registering the executor.
#define REGISTER_EXECUTOR(name) \
    REGISTER_FACTORY_FUNCTION_QUALIFIED(mediapipe::ExecutorRegistry, executor_registration, name, name::Create)
