...
void InOrderOutputStreamHandler::PropagationLoop() {
    ...
    if (!calculator_context_manager_->HasActiveContexts()) {
        ...
        calculator_context = calculator_context_manager_->GetFrontCalculatorContext(&context_timestamp);
...
void InOrderOutputStreamHandler::PropagatePackets(CalculatorContext** calculator_context, Timestamp* context_timestamp) {
    ...
    if (completed_input_timestamps_.empty() && !calculator_context_manager_->HasActiveContexts()) {
    ...
    *calculator_context = calculator_context_manager_->GetFrontCalculatorContext(context_timestamp);
    if (!completed_input_timestamps_.empty() && *context_timestamp == *completed_input_timestamps_.begin()) {
...
void InOrderOutputStreamHandler::PropagationBound(CalculatorContext** calculator_context, Timestamp* context_timestamp) {
