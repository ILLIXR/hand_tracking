...
public:
    ...
    static constexpr source_location DoNotInvokeDirectly(std::uint_least32_t line, const char* file_name) {
...
#define MEDIAPIPE_LOC mediapipe::source_location::DoNotInvokeDirectly(__LINE__, __FILE__)
