...
public:
    ...
    bool GetNext(int* node_index, bool* cyclic, std::vector<int>* output_cycle_nodes);
...
private:
    ...
    int                                                           num_nodes_left_;
    std::priority_queue<int, std::vector<int>, std::greater<int>> nodes_with_zero_indegree_;
