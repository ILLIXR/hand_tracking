...
namespace intops {
    ...
    template<typename TagType, typename NativeType, typename ValidatorType = NullStrongIntValidator>
    class StrongInt {
    public:
        ...
        constexpr StrongInt()
            : value_((ValidatorType::template ValidateInit<ValueType>(NativeType()), NativeType())) { }
        ...
        explicit StrongInt(StrongInt<ArgTagType, ArgNativeType, ArgValidatorType> arg) {
        ...
        explicit constexpr StrongInt(T init_value)
            : value_((ValidatorType::template ValidateInit<ValueType>(init_value), static_cast<ValueType>(init_value))) { }
    ...
    private:
        ...
        static_assert(std::is_integral<ValueType>::value, "invalid integer type for strong int");
    };
...
#define NUMERIC_VS_STRONG_INT_BINARY_OP(op)                                                                             \
    template<typename TagType, typename ValueType, typename ValidatorType, typename NumType>                            \
    inline StrongInt<TagType, ValueType, ValidatorType> operator op(NumType                                      lhs,   \
                                                                    StrongInt<TagType, ValueType, ValidatorType> rhs) { \
        rhs op## = lhs;                                                                                                 \
        return rhs;                                                                                                     \
    }
