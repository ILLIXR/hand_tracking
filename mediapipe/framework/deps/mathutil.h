...
public:
    ...
    static int32_t FastIntRound(double x) {
#if defined __GNUC__ && (defined __i386__ || defined __SSE2__ || defined __aarch64__ || defined __powerpc64__)
    #if defined __AVX__
        // AVX.
        int32_t result;
        __asm__ __volatile__("vcvtsd2si %1, %0"
        ...
        int64_t result;
        __asm__ __volatile__("fctid %0, %1" : "=d"(result) : "d"(x) : /* No clobbers */);
        return result;
    ...
    static int32_t FastIntRound(float x) {
        ...
        // AVX.
        int32_t result;
        __asm__ __volatile__("vcvtss2si %1, %0"
                             : "=r"(result) // Output operand is a register
                             : "xm"(x));    // Input operand is an xmm register or memory
        return result;
    #elif defined __SSE2__
        // SSE2.
        int32_t result;
        __asm__ __volatile__("cvtss2si %1, %0"
                             : "=r"(result) // Output operand is a register
                             : "xm"(x));    // Input operand is an xmm register or memory
        return result;
    #elif defined __i386__
    ...
    #elif defined __powerpc64__
        uint64_t output;
        __asm__ __volatile__("fctiw %0, %1" : "=d"(output) : "f"(x) : /* No clobbers */);
    ...
    static int64_t FastInt64Round(double x) {
#if defined __GNUC__ && (defined __i386__ || defined __x86_64__ || defined __aarch64__ || defined __powerpc64__)
    #if defined __AVX__
        // AVX.
        int64_t result;
        __asm__ __volatile__("vcvtsd2si %1, %0"
        ...
        int64_t result;
        __asm__ __volatile__("fcvtns %d0, %d1" : "=w"(result) : "w"(x) : /* No clobbers */);
        return result;
    #elif defined __powerpc64__
        int64_t result;
        __asm__ __volatile__("fctid %0, %1" : "=d"(result) : "d"(x) : /* No clobbers */);
