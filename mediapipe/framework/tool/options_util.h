...
namespace tool {
    ...
    template<typename T>
    inline T RetrieveOptions(const T& base, const PacketSet& packet_set, const std::string& tag_name = "OPTIONS") {
    ...
    template<typename T>
    inline T RetrieveOptions(const T& base, const InputStreamShardSet& stream_set, const std::string& tag_name = "OPTIONS") {
