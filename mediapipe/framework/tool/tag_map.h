...
namespace tool {
    ...
    public:
        ...
        static absl::StatusOr<std::shared_ptr<TagMap>> Create(const proto_ns::RepeatedPtrField<ProtoString>& tag_index_names) {
        ...
        static absl::StatusOr<std::shared_ptr<TagMap>> Create(const TagAndNameInfo& info) {
            std::shared_ptr<TagMap> output(new TagMap());
        ...
        CollectionItemId BeginId() const {
            return CollectionItemId(0);
        }

        CollectionItemId EndId() const {
            return CollectionItemId(num_entries_);
        }
    ...
    private:
        ...
        absl::Status Initialize(const proto_ns::RepeatedPtrField<ProtoString>& tag_index_names);
        ...
        void InitializeNames(const std::map<std::string, std::vector<std::string>>& tag_to_names);
