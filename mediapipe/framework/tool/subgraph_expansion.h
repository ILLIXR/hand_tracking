...
namespace tool {
    ...
    absl::Status ExpandSubgraphs(CalculatorGraphConfig* config, const GraphRegistry* graph_registry = nullptr,
    ...
    // connections
    CalculatorGraphConfig MakeSingleNodeGraph(CalculatorGraphConfig::Node subgraph_node);
