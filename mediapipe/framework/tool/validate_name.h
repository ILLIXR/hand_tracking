...
namespace tool {
    ...
    struct ABSL_DEPRECATED("Prefer using mediapipe::tool::TagMap instead, since this structure does "
                           "not "
    ...
    ABSL_DEPRECATED("Prefer using mediapipe::tool::TagMap instead, since this method does not "
    ...
    absl::Status ParseTagIndexName(const std::string& tag_and_name, std::string* tag, int* index, std::string* name);
    ...
    //   ":2"      -> tag: "",      index: 2
    //   ""        -> tag: "",      index: 0
    absl::Status ParseTagIndex(const std::string& tag_and_index, std::string* tag, int* index);
