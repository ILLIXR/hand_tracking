...
namespace tool {
    ...
    namespace options_field_util {
        ...
        absl::Status SetField(const FieldPath& field_path, const FieldData& value, FieldData* message_data);
        ...
        absl::Status SetFieldValues(FieldData& message_data, const FieldPath& field_path, const std::vector<FieldData>& values);
