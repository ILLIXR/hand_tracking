...
#if !defined(MEDIAPIPE_MOBILE) && (defined(__ANDROID__) || defined(__EMSCRIPTEN__))
...
// but may or may not still be able to run other OpenGL code.
    ...
    (defined(__APPLE__) || defined(__EMSCRIPTEN__) || MEDIAPIPE_DISABLE_GPU || MEDIAPIPE_USING_LEGACY_SWIFTSHADER)
